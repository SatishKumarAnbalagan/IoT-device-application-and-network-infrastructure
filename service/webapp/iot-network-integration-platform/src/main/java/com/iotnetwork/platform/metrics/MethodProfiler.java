package com.iotnetwork.platform.metrics;
...
public class MethodProfiler {
	...
	@Pointcut("execution(* com.iotnetwork.platform.controller.Controller.*(..))")
...
//		logger.error("Exception occurred in: " + joinPoint.getSignature().getName() + "Exception message: " + e.getMessage());
//	}
